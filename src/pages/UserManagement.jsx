    ...
    <div className="flex flex-col w-full h-full relative overflow-hidden bg-background">
      <header className="flex items-center justify-between px-margin-desktop py-8 bg-surface border-b border-outline-variant/30 sticky top-0 z-10">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-primary text-on-primary px-4 py-2.5 rounded-lg font-headline-sm text-sm shadow-md hover:shadow-lg transition-all hover:-translate-y-0.5 active:translate-y-0"
          >
      ...
      <div className="px-margin-desktop py-4 bg-surface-container-low border-b border-outline-variant/20 flex items-center justify-between">
        <div className="flex items-center gap-2 font-label-caps text-label-caps text-on-surface-variant flex-wrap">
          ...
          <span className="flex items-center gap-1 bg-surface py-1 px-2 rounded border border-outline-variant/30 text-on-surface hover:bg-surface-variant cursor-pointer transition-colors">
            <span className="material-symbols-outlined text-[14px]">corporate_fare</span>Compass Nepal
          </span>
          <span className="material-symbols-outlined text-[16px] text-outline">chevron_right</span>
          <span className="flex items-center gap-1 bg-surface py-1 px-2 rounded border border-outline-variant/30 text-on-surface hover:bg-surface-variant cursor-pointer transition-colors">
            <span className="material-symbols-outlined text-[14px]">category</span>Child Protection
          </span>
          <span className="material-symbols-outlined text-[16px] text-outline">chevron_right</span>
          <span className="flex items-center gap-1 bg-surface py-1 px-2 rounded border border-outline-variant/30 text-on-surface hover:bg-surface-variant cursor-pointer transition-colors">
            <span className="material-symbols-outlined text-[14px]">location_on</span>Kathmandu
          </span>
          <span className="material-symbols-outlined text-[16px] text-outline">chevron_right</span>
          <span className="flex items-center gap-1 bg-primary-container text-on-primary-container py-1 px-2 rounded border border-primary/20">
            <span className="material-symbols-outlined text-[14px]">badge</span>Case Manager
          </span>
        </div>
                ...
                <td className="p-4">
                  <div className="flex items-center gap-3">
                    <img
                      ...
                      alt="Anjali Gurung"
                      src="https://lh3.googleusercontent.com/aida-public/AB6AXuAHPR2SYkTLfleEXDHt-QQMBfGA0xNxKeqTcQipKTjQK4VDVYoesuX4a3Efjc-Oo-d-KLdi5QTj7h-8gN35Ue1e9fEz4BIdstOaOu3Brrjownt9gx4_X_fkcOf2HTgnqG9I4BcefjQcuywHnKBobgSF5PUKaqYQ4YothhALTOB8UHoUaXGG_UVYxzJA2NstxbW9MJbJsepHd2bzmZBeCqpH2ecFQ4pNK1KhGuYLN_DpgqKyEuC_0v4I"
                    />
                    <div>
                ...
                <td className="p-4">
                  <div className="flex items-center gap-3">
                    <img
                      ...
                      src="https://lh3.googleusercontent.com/aida-public/AB6AXuATSocJ3B8ifSTYnxzHpvo1PLQPFiTreVSoT8mrwTbg8eiWIMq3V77maCsIrrdO5eDEttSSvIsG8uqFtoexLbprW5dtZVxyCVHTjT1t_ycm5DrjZittUtjiGSnYFgVcmqoKlPtidvTT5wU3Dz5cVL-UUAZk_fKPVEOXOiQf940vB4iwWuqW0M-zM8rsceCyxoH3ApgZ2StAAiATzLPzwd_fr83kFtg3cLugA1SueirhdzePExUY2k94"
                    />
                    <div>
      ...
      <div
        ...
        className={`fixed inset-y-0 right-0 w-[480px] bg-surface shadow-[-4px_0_24px_rgba(0,0,0,0.1)] z-50 transform transition-transform duration-300 ease-in-out flex flex-col border-l border-outline-variant/30 ${!isDrawerOpen ? 'translate-x-full' : 'translate-x-0'}`}
      >
        ...
        <div className="p-6 border-t border-outline-variant/30 bg-surface-container-lowest flex justify-end gap-3">
          <button
            className="px-4 py-2 font-headline-sm text-sm text-on-surface-variant border border-outline-variant rounded-lg hover:bg-surface-variant transition-colors"
            onClick={() => setIsDrawerOpen(false)}
          >
            Cancel
          </button>
      ...
      {isDrawerOpen && (
        <div
          className="fixed inset-0 bg-on-surface/20 backdrop-blur-sm z-40 transition-opacity opacity-100"
          id="drawer-backdrop"
          onClick={() => setIsDrawerOpen(false)}
        ></div>
      )}
